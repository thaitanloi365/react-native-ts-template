...
const testflight = require('./scripts/testflight/testflight')
...
const updatePackageJson = fileName => {
  try {
    ...
    packageJson.scripts.cpc = `appcenter apps create -d ${androidAppName} -o Android -p React-Native`
    packageJson.scripts.acpc = `appcenter apps create -d ${iosAppName} -o iOS -p React-Native`
    ...
    packageJson.scripts.clearIOS = `appcenter codepush deployment clear -a thaitanloi365/RMW-iOS Staging`
    packageJson.scripts.clearIOSProd = 'appcenter codepush deployment clear -a thaitanloi365/RMW-iOS Production'
    packageJson.scripts.clearAndroid = 'appcenter codepush deployment clear -a thaitanloi365/RMW-Android Production'
    packageJson.scripts.clearAndroidProd = 'appcenter codepush deployment clear -a thaitanloi365/RMW-Android Production'
