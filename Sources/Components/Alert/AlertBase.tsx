...
class AlertBase extends React.Component<Props, State> {
  ...
  render() {
    ...
    return (
      <Overlay ref={this.overlayRef} animated={overlayAnimated} duration={overlayDuration}>
        <Animated.View style={[styles.container, style, animationStyle]}>{children}</Animated.View>
      </Overlay>
    )
  }
}
