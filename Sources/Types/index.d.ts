...
type TouchableExtrasProps = TouchableNativeFeedbackProps & TouchableOpacityProps
...
export type TextInputValidateType = 'none' | 'empty' | 'length' | 'email' | 'phone' | 'regex'
...
type ImageViewExtraProps = Pick<ImageProps, 'resizeMethod' | 'resizeMode' | 'source'>
...
export type ActionSheetHeaderProps = ViewProps & {
  title?: string
  titleStyle?: StyleProp<TextStyle>
  message: string
...
export type ActionSheetProps = ViewProps & {
  children: Array<JSX.Element>
}

export type BaseIndicatorProps = ViewProps & {
  count?: number
  renderComponent?: (index: number, count: number, progress: Animated.Value) => void
  animating?: boolean
...
export type AndroidIndicatorProps = BaseIndicatorProps

export type IOSIndicatorProps = BaseIndicatorProps

export type BallIndicatorProps = BaseIndicatorProps

export type PacmanIndicatorProps = BaseIndicatorProps

export type PulseIndicatorProps = BaseIndicatorProps

export type DotIndicatorProps = BaseIndicatorProps

export type BarIndicatorProps = BaseIndicatorProps

export type SkypeIndicatorProps = BaseIndicatorProps & {
  minScale?: number
  maxScale?: number
}

export type WaveIndicatorProps = BaseIndicatorProps & {
  waveFactor?: number
  waveMode: 'Fill' | 'Outline'
}

export type IndicatorProps = BaseIndicatorProps & {
  type: 'Android' | 'iOS' | 'Ball' | 'Bar' | 'Dot' | 'Patman' | 'Pulse' | 'Skype' | 'Wave'
  minScale?: number
  maxScale?: number
  waveFactor?: number
  waveMode?: 'Fill' | 'Outline'
